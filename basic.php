					...
					<section id="sidebar">
						...
						<!-- Intro -->
							<section id="intro">
								...
								<header>
									<div class="rank" style="height:80px;width:80px;display:block;float:left;">
										<img style="display:block;width:100%;height:auto;" src="http://files.bf4stats.com/img/<?php print $clan->logo; ?>" />
									</div>
