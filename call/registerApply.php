<?php
	...
	foreach ($data as $user) {
		if ( $user['username'] == $newUser['username'] ){
			$return['error']['field'][] = "username";
			$return['message'] = "<br />Este player já está na fila para aprovação.";
		}
	}
	...
	if ( $return ) {
		...
		$return['sucess'] = true;
		$return['message'] = "Player entrou na fila do Apply. Agora basta aguardar a aprovação.";
		print json_encode($return);
		exit;
